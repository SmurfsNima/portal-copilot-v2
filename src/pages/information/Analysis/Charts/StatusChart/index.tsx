                    ...
                    <div className="flex justify-between w-[155px] items-center mt-4">
                        <div className="ml-4">
                            <div className=" text-light-primary-text dark:text-[#FFFFFF99] text-[12px] text-center font-light">Current</div>
                             <div className=" text-light-secandary-text font-medium dark:text-[#FFFFFF99] text-[12px]  w-[120px] overflow-hidden h-[35px] mt-1 text-center">{data.value.current}</div>
                        </div>
