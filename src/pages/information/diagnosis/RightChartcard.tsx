...
export const RightChartCard: React.FC<chartCardProps> = ({
  ...
  return (
    <div className={`${theme} bg-black-secondary w-full  border rounded-xl border-main-border  px-2  py-1  `}>
      ...
      <div className="bg-black-secondary border border-main-border px-2   h-full max-h-[140px] xl:max-h-[162px] 2xl:max-h-[175px] rounded-lg ">
        ...
        {
            type === "Blood Pressure" ? <MixedLinesChart active={false}/> :  <LineChart dashed model={type === "CBC" ? "linear" :  "line"} active={false}  />
        }
