                                ...
                                <div className="w-full flex justify-between">
                                        ...
                                        <div className="px-5 flex flex-col gap-4 mt-6">
                                            <div className="flex w-full items-center justify-between">
                                                <div className="flex items-center gap-1">
                                                    ...
                                                    <div className="text-[12px] font-medium dark:text-[#FFFFFFDE] text-light-primary-text">Total workouts:</div>
                                                </div>
                                                <div className="dark:text-[#FFFFFF99] text-light-secandary-text text-[12px]">{data?.personal_info["total workouts"]}</div>
                                            </div>

                                            <div className="flex w-full items-center justify-between">
                                                <div className="flex items-center gap-1">
                                                    <img className="Aurora-icons-DataEntry w-[15px]" alt="" />
                                                    <div className="text-[12px] font-medium dark:text-[#FFFFFFDE] text-light-primary-text">Total Cardio Activities:</div>
                                                </div>
                                            ...
                                            <div className="flex w-full items-center justify-between">
                                                <div className="flex items-center gap-1">
                                                    <div className="text-[12px] font-medium dark:text-[#FFFFFFDE] text-light-primary-text">Expert:</div>
                                                </div>
                                                <div className="dark:text-[#FFFFFF99] text-light-secandary-text text-[12px]">{data?.personal_info["expert"]}</div>
                                            </div>  

                                            <div className="flex w-full items-center justify-between">
                                                <div className="flex items-center gap-1">
                                                    <div className="text-[12px] font-medium dark:text-[#FFFFFFDE] text-light-primary-text">Location:</div>
                                                </div>
                                                <div className="dark:text-[#FFFFFF99] text-light-secandary-text text-[12px]">{data?.personal_info["Location"]}</div>
                                            </div>  

                                            <div className="flex w-full items-center justify-between">
                                                <div className="flex items-center gap-1">
                                                    {/* <img className="Aurora-icons-DataEntry w-[15px]" alt="" /> */}
                                                    <div className="text-[12px] font-medium dark:text-[#FFFFFFDE] text-light-primary-text">E-mail:</div>
                                                </div>
                                                <div className="dark:text-[#FFFFFF99] text-light-secandary-text text-[12px]">{data?.personal_info["email"]}</div>
                                            </div>                                                                                                                                                                                                       
                                        </div>
                                    </div>
                                    <div className="w-[300px] h-[388px] border border-light-border-color dark:border-none dark:bg-[#272727] rounded-[16px]">
                                        <div className="w-full flex justify-between px-5 py-3">
                                            <div className="text-[14px] text-light-secandary-text dark:text-[#FFFFFFDE]">Data Syncing</div>
                                                            ...
                                                            {data["Data Syncing"]?.map((el:any) => {
                                                                return(
                                                                    <div className="dark:bg-[#2F2F2F] border border-light-border-color dark:border-none mb-1 px-4 h-[48px] w-full rounded-[12px] flex justify-between items-center">
                                                                        <div className="text-[10px] w-[50px] text-light-secandary-text dark:text-[#FFFFFFDE]">{el.Data}</div>
                                    ...
                                    <div className="w-[300px] h-[388px] border border-light-border-color dark:border-none dark:bg-[#272727] overflow-hidden rounded-[16px]">
                                        <div className="w-full flex justify-between px-5 py-3">
                                            <div className="text-[14px] text-light-secandary-text dark:text-[#FFFFFFDE]">Data Tracking</div>
                                        </div>
                                        <div className="w-full border-t border-[#383838]"></div>
                                        <div className="px-2 mt-2">
