...
axios.interceptors.response.use((response) => {
    ...
    if(response.data.detail &&response.data.notif!=true &&response.data.detail !='Invalid token.' &&response.data.detail !='This user dose not have any score.' && response.data.detail !='Not Found'){
